...
output_fps = 24  # Frames per second for the saved video
...
# Input video path
input_video_path = "example_videos/good.m4v"
...
while True:
    ...
    for y_idx, y in enumerate(y_centers):
        for x_idx, x in enumerate(x_centers):
            ...
            cv2.arrowedLine(frame, start_point, end_point, (0, 0, 255), 2, tipLength=0.2)
